...
public final class Config {
    ...
    public static String BASE_PATH            = "D:\\Pes Editor";
    
    // Projeto selecionado
    public static String PROJECT_NAME         = "Projeto 1";
    ...
    public final static String TITLE    = "PES 2018 Editor by Marcos Santos";
    public static final String ID_FLAG  = "#";

    
    public final static Color MOSTLY_WHITE = Color.WHITE;//new Color(250, 250, 250);
